/**
 * Organic curve primitives for procedural creature and environmental sprite recipes.
...
export function drawOrganicBlob(
  ...
  for (let i = 0; i < points; i++) {
    const wobbleFactor = 1 + Math.sin(i * 2.399) * wobble; // deterministic, stable bake output
