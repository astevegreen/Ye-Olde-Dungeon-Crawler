...
- Scope: `src/engine/`, `tests/`, `scripts/`. Purity review also covers any `src/content/` file registered as a manifest hook or handler (see ARCHITECTURE.md §2: purity is defined by execution path, not file location).
- Hard Constraints:
